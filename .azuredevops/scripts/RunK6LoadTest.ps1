...
#### Trial starts
az storage file upload-batch --account-name $storageAccountName --account-key $storageAccountKey --source $loadTestUtilPath --destination "$loadTestIdentifier/$loadTestUtilPath"

az storage file upload-batch --account-name $storageAccountName --account-key $storageAccountKey --source $loadTestProjectPath --destination "$loadTestIdentifier/$loadTestProjectPath"
### Trail ends
