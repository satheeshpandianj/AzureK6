...
az storage file upload --account-name $storageAccountName --account-key $storageAccountKey --share-name $storageShareName --source "/$PSScriptRoot/summary.html" --path "/$PSScriptRoot/$loadTestIdentifier/summary.html"
